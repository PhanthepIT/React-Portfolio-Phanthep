...
import './CarouselCustom.css';  // Import your custom CSS file
import image1 from '../assets/certificate/python_basic_certificate.jpg';
import image2 from '../assets/certificate/sql_basic_certificate.jpg';
import image3 from '../assets/certificate/sql_intermediate.jpg';
...
const images = [
  {
    ...
    details: 'This is the Python basic certificate',
  },
  {
    src: image2,
    name: 'SQL Basic Certificate',
    details: 'This is the SQL basic certificate',
  },
  {
    src: image3,
    name: 'SQL Intermediate Certificate',
    details: 'This is the SQL intermediate certificate',
  },
];
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <motion.h2
        ...
        className="my-20 text-center text-4xl">Hackerrank</motion.h2>
      <motion.div
